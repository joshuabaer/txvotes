...
worker/tests/
├── 17 test files      # 1255+ tests (vitest + happy-dom)
worker/public/
...
1255+ tests across 17 test files covering interview flows, guide generation, routing, bias detection, token budgets, audit scoring, rate limiting, SSE streaming, and more.
